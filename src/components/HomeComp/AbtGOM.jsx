  ...
  return (
    <div className=" py-20 bg-gray-50 px-6 md:px-10 lg:px-16 xl:px-40 transform transition-all grid grid-cols-1 gap-12 items-center md:grid-cols-2">
      <div>
        ...
        <button className="font-semibold rounded-lg transition-all duration-300 cursor-pointer whitespace-nowrap border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white px-6 py-3 text-base">
          Learn More About Us
        </button>
      </div>
